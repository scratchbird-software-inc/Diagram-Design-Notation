...
**DDN 0.7.0.** `chart.basic@1` remains unchanged for earlier single-series and arc examples. The additive `chart.quality@1` profile supplies explicit series, layered marks, and four named transforms. No JavaScript/SQL/FEEL expression evaluation or remote data loading is introduced.
