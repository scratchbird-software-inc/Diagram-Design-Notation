...
**DDN 0.5.0-draft.1.** This chapter completes the fourth implementation stage: real child-view composition, box-plot integration (chapter 22), and selected local notation gaps. A useful supported profile is not blanket external-standard conformance.
