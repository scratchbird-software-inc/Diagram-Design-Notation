...
**DDN 0.7.0. Implemented reference contract.** This chapter adds profiles without changing the separation of data, reusable formats, and named views. Source remains UTF-8. Runtime capabilities, examples, validators, and the public library must agree; a source property must not silently select an unimplemented algorithm.
