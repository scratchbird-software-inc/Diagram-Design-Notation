...
const A=require('../dist/ddn.global.js'),P=require('../runtime/ddn-palette.js').default,fs=require('fs'),assert=require('assert/strict'),root=require('path').resolve(__dirname,'..');
