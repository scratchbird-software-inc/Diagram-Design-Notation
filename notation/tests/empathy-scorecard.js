...
const dir=path.resolve(__dirname,'../../examples/basics'),base={'34-empathy-scorecard.ddn':fs.readFileSync(dir+'/34-empathy-scorecard.ddn','utf8'),'shared.ddn':fs.readFileSync(dir+'/shared.ddn','utf8')};
