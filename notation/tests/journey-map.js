...
const dir=path.resolve(__dirname,'../../website/examples/basics'),FILE='35-journey-map.ddn',base={[FILE]:fs.readFileSync(dir+'/'+FILE,'utf8'),'shared.ddn':fs.readFileSync(dir+'/shared.ddn','utf8')};
