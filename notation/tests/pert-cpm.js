...
const dir=path.resolve(__dirname,'../../examples/basics'),FILE='52-pert-cpm.ddn',base={[FILE]:fs.readFileSync(dir+'/'+FILE,'utf8'),'shared.ddn':fs.readFileSync(dir+'/shared.ddn','utf8')};
