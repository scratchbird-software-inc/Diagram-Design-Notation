...
|---|---|---|---|---|---|
| `ddn-core.js` / `.mjs` / `.min.js` | Parse/build/validate/export plus the workspace API (no rendering). | — | 672542 | 667884 | 580577 | 128239 |
...
| `ddn-projections.js` / `.mjs` / `.min.js` | Data-bound projections: chart/matrix/panels/timeline/table/sequence/timing/chen. | ddn-core.js + ddn-graph.js | 88150 | 86746 | 72664 | 26825 |
| `ddn.global.js` / `.mjs` / `.min.js` | All-in-one: every bundle above plus the Studio web component. Unchanged name and behavior; this is what the test suites and standalone pages embed. | — | 949010 | 940154 | 797682 | 205563 |
