...
|---|---|---|---|---|---|
| `ddn-core.js` / `.mjs` / `.min.js` | Parse/build/validate/export plus the workspace API (no rendering). | — | 658911 | 654483 | 568765 | 124672 |
...
| `ddn-projections.js` / `.mjs` / `.min.js` | Data-bound projections: chart/matrix/panels/timeline/table/sequence/timing/chen. | ddn-core.js + ddn-graph.js | 73891 | 72681 | 60432 | 22898 |
| `ddn.global.js` / `.mjs` / `.min.js` | All-in-one: every bundle above plus the Studio web component. Unchanged name and behavior; this is what the test suites and standalone pages embed. | — | 921120 | 912688 | 773564 | 198241 |
