...
|---|---|---|---|
| `ddn-core.js` | Parse/build/validate/export plus the workspace API (no rendering). | — | 627300 |
...
| `ddn.global.js` | All-in-one: every bundle above plus the Studio web component. Unchanged name and behavior; this is what the test suites and standalone pages embed. | — | 864895 |
