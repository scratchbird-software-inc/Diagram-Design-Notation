...
view={'type':'object','required':['id','name','local','selected','relations','profiles','keys','placements','routes','subdiagrams','frames'],'properties':{'id':{'type':'string'},'name':{'type':'string'},'local':{'type':'string'},'selected':{'type':'array','items':{'type':'string'},'uniqueItems':True},'relations':{'type':'array','items':{'type':'string'},'uniqueItems':True},'profiles':{'type':'object','required':['notation','style','layout','display','publication','legend']},'keys':{'type':'object','additionalProperties':{'type':'integer','minimum':1}},'placements':{'type':'object'},'routes':{'type':'object'},'subdiagrams':{'type':'array'},'frames':{'type':'array'},'source':{'$ref':'#/$defs/source'}},'additionalProperties':False}
resolved={'$schema':S,'$id':'urn:ddn:schema:resolved:0.3','title':'DDN reference resolved view interchange 0.3','description':'Structural schema of the distributed reference IR. Cross-record semantics and production profile obligations require additional validation.','type':'object','required':['format','language','registry','entry','view','elements','relations','diagnostics'],'properties':{'format':{'enum':['ddn-resolved@0.3','ddn-resolved@0.4','ddn-resolved@0.5']},'language':{'enum':['0.3','0.4','0.5']},'registry':{'const':'ddn-core@0.3'},'entry':{'type':'string'},'view':{'$ref':'#/$defs/view'},'elements':{'type':'array','items':{'$ref':'#/$defs/element'}},'relations':{'type':'array','items':{'$ref':'#/$defs/relation'}},'diagnostics':{'type':'array','items':{'$ref':'#/$defs/diagnostic'}},'publication':{'type':'object'}},'additionalProperties':False,'$defs':{'value':value,'source':source,'member':member,'element':element,'endpoint':endpoint,'relation':relation,'diagnostic':diag,'view':view}}
