...
The deliverable accompanies the audited 0.5.0-draft.2 endpoint-ordering patch. Its runtime SHA-256 is recorded in `audit/library-audit.json`. This package changes no existing Studio or renderer files. The interactive review prototype demonstrates a subset and labels the rest as design screens.
