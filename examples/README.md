...
- `basics/` — 32 numbered examples (01-customer … 32-canvas-pack-b)
  ...
  concept maps, EPC process chains, and canvas packs (BMC/Lean plus
  environmental-scan and five-forces canvases).
